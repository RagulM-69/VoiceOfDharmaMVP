        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            <div className="flex items-center mb-6">
              <div className="relative w-36 h-36 md:w-44 md:h-44 -ml-4 -mt-4">
                <Image 
              ...
              {socialLinks.map(({ key, url }) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 rounded-full border border-amber-400/40 flex items-center justify-center text-amber-400 hover:bg-amber-400 hover:text-[#0A1F44] transition-all duration-200 hover:border-amber-400 hover:scale-110"
                  >
                    {meta?.svg ?? DEFAULT_ICON}
                  </a>
                )
              })}
            </div>
